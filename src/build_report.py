...
<code>src/verify_pass.py</code>. Raw evidence is stored in
<code>data/raw/research_evidence.json</code>; first-pass output in
<code>data/processed/first_pass.json</code>.
</p>
</section>
